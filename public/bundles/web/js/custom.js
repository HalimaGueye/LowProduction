...
$myProject.on('show.bs.collapse','.collapse', function() {
    $myProject.find('.collapse.in').collapse('hide');
});
...
$(".btn-more").click(function() {
	var modif = "En savoir plus";

	if($(this).html()=="En savoir plus"){
		modif = "En savoir moins";
	}

	$(".btn-more").each(function(index, value){
		$(value).html("En savoir plus");
	});
