 ...
 */
class getRoleProjectRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RoleProjectRepository' shared autowired service.
     *
     * @return \App\Repository\RoleProjectRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RoleProjectRepository.php';

        return $container->privates['App\\Repository\\RoleProjectRepository'] = new \App\Repository\RoleProjectRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
