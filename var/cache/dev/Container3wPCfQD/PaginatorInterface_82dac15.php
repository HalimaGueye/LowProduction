...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializera2837 && ($this->initializera2837->__invoke($valueHoldere59d5, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializera2837) || 1) && $this->valueHoldere59d5 = $valueHoldere59d5;

        if ($this->valueHoldere59d5 === $returnValue = $this->valueHoldere59d5->paginate($target, $page, $limit, $options)) {
            return $this;
        }
