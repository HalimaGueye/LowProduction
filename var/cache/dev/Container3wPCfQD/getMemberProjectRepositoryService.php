 ...
 */
class getMemberProjectRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MemberProjectRepository' shared autowired service.
     *
     * @return \App\Repository\MemberProjectRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MemberProjectRepository.php';

        return $container->privates['App\\Repository\\MemberProjectRepository'] = new \App\Repository\MemberProjectRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
