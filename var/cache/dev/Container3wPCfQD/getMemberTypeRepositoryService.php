 ...
 */
class getMemberTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MemberTypeRepository' shared autowired service.
     *
     * @return \App\Repository\MemberTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MemberTypeRepository.php';

        return $container->privates['App\\Repository\\MemberTypeRepository'] = new \App\Repository\MemberTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
