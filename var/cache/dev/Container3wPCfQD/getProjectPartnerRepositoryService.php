 ...
 */
class getProjectPartnerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjectPartnerRepository' shared autowired service.
     *
     * @return \App\Repository\ProjectPartnerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjectPartnerRepository.php';

        return $container->privates['App\\Repository\\ProjectPartnerRepository'] = new \App\Repository\ProjectPartnerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
