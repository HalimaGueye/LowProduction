 ...
 */
class getSupportersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SupportersRepository' shared autowired service.
     *
     * @return \App\Repository\SupportersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SupportersRepository.php';

        return $container->privates['App\\Repository\\SupportersRepository'] = new \App\Repository\SupportersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
