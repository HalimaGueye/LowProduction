 ...
 */
class getNewActivityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NewActivityRepository' shared autowired service.
     *
     * @return \App\Repository\NewActivityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NewActivityRepository.php';

        return $container->privates['App\\Repository\\NewActivityRepository'] = new \App\Repository\NewActivityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
