 ...
 */
class getProjectCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjectCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\ProjectCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjectCategoryRepository.php';

        return $container->privates['App\\Repository\\ProjectCategoryRepository'] = new \App\Repository\ProjectCategoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
