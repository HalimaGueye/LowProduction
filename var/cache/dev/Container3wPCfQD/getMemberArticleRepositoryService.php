 ...
 */
class getMemberArticleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MemberArticleRepository' shared autowired service.
     *
     * @return \App\Repository\MemberArticleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MemberArticleRepository.php';

        return $container->privates['App\\Repository\\MemberArticleRepository'] = new \App\Repository\MemberArticleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
