 ...
 */
class getPartnerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PartnerRepository' shared autowired service.
     *
     * @return \App\Repository\PartnerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PartnerRepository.php';

        return $container->privates['App\\Repository\\PartnerRepository'] = new \App\Repository\PartnerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
