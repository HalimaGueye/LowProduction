 ...
 */
class getPortfolioTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PortfolioTypeRepository' shared autowired service.
     *
     * @return \App\Repository\PortfolioTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PortfolioTypeRepository.php';

        return $container->privates['App\\Repository\\PortfolioTypeRepository'] = new \App\Repository\PortfolioTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
